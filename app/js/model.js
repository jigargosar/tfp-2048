...
TFP.APP2048.Grid = (function (_, A) {
    ...
    var listToRowsAndBack = function (fnList) {
    ...
    return {
        ...
        slideLeft: listToRowsAndBack([
            slideRowsLeft
        ]),
        slideTop: listToRowsAndBack([
            _.apply(_.compose, _.repeat(_.transpose, 1)),
            slideRowsLeft,
            _.apply(_.compose, _.repeat(_.transpose, 3))
        ])
    };
